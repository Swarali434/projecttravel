...
<body>
        ...
        <div class="hero-content">
            ...
            <div class="search-container">
                <form action="search.jsp" method="get">
                    <input type="text" placeholder="Where would you like to learn?" name="destination">
    ...
    <section class="featured-trips">
        ...
        <div class="trips-container">
            ...
            <div class="trip-card">
                ...
                <div class="trip-details">
                    ...
                    <a href="trip-details.jsp?id=1" class="btn btn-view-details">View Details</a>
                </div>
            </div>
            ...
            <div class="trip-card">
                ...
                <div class="trip-details">
                    ...
                    <a href="trip-details.jsp?id=2" class="btn btn-view-details">View Details</a>
                </div>
            </div>
        ...
        <div class="view-all-container">
            <a href="destinations.jsp" class="btn btn-view-all">View All Educational Trips</a>
        </div>
    </section>
    ...
    <section class="college-collab">
        ...
        <div class="college-cta">
            ...
            <a href="college-partnership.jsp" class="btn btn-partner">Become a Partner</a>
        </div>
    </section>
